...
<div
	class="max-w-sm w-full dark:bg-black bg-white shadow-lg rounded-lg pointer-events-auto">
	<div
		class="rounded-lg shadow-xs overflow-hidden dark:border-pink-500 dark:border-2">
		<div class="p-4">
