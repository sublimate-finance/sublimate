...
interface StreamableWrappedETHInterface extends ethers.utils.Interface {
  functions: {
...
export class StreamableWrappedETH extends Contract {
  ...
  interface: StreamableWrappedETHInterface;
