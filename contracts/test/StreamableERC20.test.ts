...
describe('StreamableERC20', function () {
	...
	beforeEach(async function () {
		...
		this.contract = await ethers.getContractAt('IStreamableERC20', '0x89205A3A3b2A69De6Dbf7f01ED13B2108B2c43e7')
	})
	...
	it('should have 0 balance by default', async function () {
		...
		expect(balance).to.be.bignumber.eq(ethers.utils.parseEther('0'))
	})
